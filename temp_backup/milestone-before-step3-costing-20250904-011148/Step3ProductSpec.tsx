...
const createEmptyProduct = (): Product => ({
  ...
  flatSize: { width: 9, height: 5.5, spine: 0 }, // Default values: 9W x 5.5H
  closeSize: { width: 9, height: 5.5, spine: 0 }, // Default values: 9W x 5.5H
  useSameAsFlat: true,
  ...
  bagPreset: undefined,
  gusset: undefined,
  bleed: 0.3, // Default 3mm for Business Card
  gap: 0.6,   // Default 6mm for Business Card
  gripper: 0.9,
  otherEdges: 0.5
});
