...
// Excel-Based UAE Offset Printing Pricing (AED) - From Client's Excel Sheet
const DEFAULT_OFFSET_PRICING = {
  parentCost: 8.00,      // AED per parent sheet (from Excel analysis)
  plateCost: 120.00,     // AED per plate (from Excel analysis)
  makeReadySetup: 200.00, // AED setup cost (from Excel analysis)
  makeReadySheets: 10,   // Number of make-ready sheets (from Excel analysis)
  runPer1000: 60.00,     // AED per 1000 impressions (from Excel analysis)
  cutOpRate: 8.00        // AED per cut operation (from Excel analysis)
};
