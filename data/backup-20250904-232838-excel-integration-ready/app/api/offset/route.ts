...
// Real UAE Offset Printing Pricing (AED)
const DEFAULT_OFFSET_PRICING = {
  parentCost: 8.00,      // AED per parent sheet (realistic UAE rate)
  plateCost: 120.00,     // AED per plate (realistic UAE rate)
  makeReadySetup: 200.00, // AED setup cost (realistic UAE rate)
  makeReadySheets: 10,   // Number of make-ready sheets
  runPer1000: 60.00,     // AED per 1000 impressions (realistic UAE rate)
  cutOpRate: 8.00        // AED per cut operation (realistic UAE rate)
};
