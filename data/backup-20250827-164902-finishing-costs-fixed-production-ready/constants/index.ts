import { Building2Icon, FileTextIcon, LayoutDashboardIcon, LucideIcon, PackageIcon, SquarePenIcon, UsersIcon, UserCheckIcon } from "lucide-react";
...
export const getSidebarItems = (role: "admin" | "estimator"): SidebarItem[] => {
  const common: SidebarItem[] = [
    ...
    { label: "Sales Person",      route: "/sales-person",     icons: UserCheckIcon }, // New sales person management
  ];
