...
async function pullFromProductionWithEnv() {
  try {
    console.log('🚀 Starting data pull from production database using environment variables...');
    ...
    // Step 2: Pull Users from Production Database
    ...
    // Step 3: Pull Suppliers from Production Database
    ...
    // Step 4: Pull Materials from Production Database (without GSM field for now)
    ...
    // Step 5: Pull Clients from Production Database
    ...
    // Step 6: Pull Quotes from Production Database
    ...
    // Step 7: Pull Search History from Production Database
    ...
    // Step 8: Pull Search Analytics from Production Database
    ...
    // Step 10: Restore Users (only if they don't exist)
    ...
    // Step 11: Restore Suppliers (only if they don't exist)
    ...
    // Step 12: Restore Clients (only if they don't exist)
    ...
    // Step 14: Restore Quotes and related data
