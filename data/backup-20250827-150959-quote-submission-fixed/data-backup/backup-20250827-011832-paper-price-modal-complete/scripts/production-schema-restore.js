...
// Import the Prisma client generated from production schema
...
async function productionSchemaRestore() {
  try {
    console.log('🚀 Starting production data pull using production schema...');
