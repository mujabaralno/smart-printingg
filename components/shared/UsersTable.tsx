        ...
        <Table>
          <TableHeader className="bg-[#F8F8FF]">
            <TableRow className="border-slate-200">
              ...
              <TableHead className="w-10 text-slate-600 text-md p-4 font-semibold">Action</TableHead>
                ...
                <TableRow key={u.id} className="hover:bg-slate-50 transition-colors duration-200 border-slate-100">
                  ...
                  <TableCell className="p-4">
                    <div className="flex items-start gap-3">
                      <div className="mt-1 h-8 w-8  rounded-full bg-[#27aae1]/20 text-[#27aae1] flex items-center justify-center overflow-hidden">
                        {u.profilePicture ? (
                  ...
                  {/* Status */}
                  <TableCell className="p-4"><StatusPill status={u.status} /></TableCell>
